...
function App() {
  ...
  // Initial default apples: only Royal Gala and Pink Lady.
  const defaultApples = {
  ...
  const recordComparison = (winnerId) => {
    ...
    const newComparison = { date: today, apple1Id: apple1, apple2Id: apple2, winnerId: winnerId };
  ...
  // Save to localStorage when apples, comparisons, or nextAppleId change.
  useEffect(() => {
